...
!!NOTE!!: The first 3 times will fail because the fresh installation of V-REP will popup a message saying "This simulation will run with custom simulation parameters". You have to select the checkbox saying "Do not show ..." 3 times for it to go away permanently. Then you can start the real training.
