...
class Agent(object):
    def __init__(self, env: Environment, learn_rate=0.1, discount=0.9, epsilon=0.2, q_init_val=0.0):
    ...
    def execute_episode(self, max_steps: int):
        total_reward = 0
        total_steps = 0
        ...
        return total_reward, total_steps, self.env.is_goal_achieved()
